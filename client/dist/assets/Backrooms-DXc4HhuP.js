...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function ao(){return new Hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function oo(){return new Hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ws(),fragmentShader:`
...
`)}function hp(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(pi).join(`
...
#define LOW_PRECISION`),t}function vp(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Xo?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Wc?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===on&&(t="SHADOWMAP_TYPE_VSM"),t}function xp(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case vi:case xi:t="ENVMAP_TYPE_CUBE";break;case Ir:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Mp(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case xi:t="ENVMAP_MODE_REFRACTION";break}return t}function Sp(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case zs:t="ENVMAP_BLENDING_MULTIPLY";break;case pl:t="ENVMAP_BLENDING_MIX";break;case ml:t="ENVMAP_BLENDING_ADD";break}return t}function yp(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Ep(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=vp(e),l=xp(e),h=Mp(e),u=Sp(e),f=yp(e),p=e.isWebGL2?"":lp(e),g=hp(e),_=up(s),m=i.createProgram();let d,E,x=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(d=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,_].filter(pi).join(`
`),d.length>0&&(d+=`
`),E=[p,"#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,_].filter(pi).join(`
`),E.length>0&&(E+=`
