...
export default function App() {
  ...
  useEffect(() => {
    ...
    pull();
    // The verified disguise needs no push here: livekitVoice restores it at
    // start-up together with the room it belongs to, and applies it when (and
    // only when) that room is joined again.
