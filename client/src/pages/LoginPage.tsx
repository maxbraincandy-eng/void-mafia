    ...
    <div className="min-h-screen bg-neon-grid-animated scanlines flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        >
          ...
          <div
            className="w-full flex items-center justify-between gap-3 py-3 px-4 rounded-2xl border cursor-not-allowed select-none opacity-40"
            style={{ background: 'rgba(24,119,242,0.06)', borderColor: 'rgba(24,119,242,0.18)' }}
          >
            <div className="flex items-center gap-3">
              <svg viewBox="0 0 24 24" className="w-5 h-5 flex-shrink-0 fill-current text-[#1877F2]/60" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <div className="flex items-center gap-3">
              <svg viewBox="0 0 24 24" className="w-5 h-5 flex-shrink-0 fill-current text-white/50" xmlns="http://www.w3.org/2000/svg">
