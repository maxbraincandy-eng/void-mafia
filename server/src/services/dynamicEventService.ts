...
export const EVENT_CATALOG: readonly EventDef[] = [
  {
...
const FREQUENCY_CHANCE: Record<'low' | 'medium' | 'high', number> = {
  low: 0.10,
  medium: 0.20,
  high: 0.35,
};

export function tryTriggerEvent(room: Room, phase: Phase): ActiveEvent | null {
...
export function setRoomEvent(room: Room, event: ActiveEvent | null): void {
...
export function clearRoomEvent(room: Room): void {
