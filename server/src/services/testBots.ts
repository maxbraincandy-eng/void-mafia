...
export function isBot(playerId: string | null | undefined): boolean {
 ...
 */
export async function isOwner(profileId: string | null | undefined): Promise<boolean> {
  if (!profileId || isBot(profileId)) return false;
  try {
