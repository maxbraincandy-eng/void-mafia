 ...
 */
export declare const PHRASES: string[];
/** How long the reader has, and how long everybody has to vote. */
export declare const READ_SECONDS = 25;
export declare const VOTE_SECONDS = 25;
/** Who gets what. */
export declare const POINTS_CORRECT_GUESS = 2;
/** The reader earns this for each player who voted for somebody else. */
export declare const POINTS_PER_FOOLED = 1;
/**
 ...
 */
export declare function pickPhrase(used: number[]): number;
/**
 ...
 */
export declare function pickReader(players: {
    userId: string;
    seat: number;
    timesRead: number;
    connected: boolean;
 ...
 */
export declare function scoreRound(readerId: string, votes: Record<string, string>): {
    correct: string[];
    fooled: number;
    points: Record<string, number>;
};
//# sourceMappingURL=whoSaidPhrases.d.ts.map