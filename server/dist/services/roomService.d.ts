import { Room, Player, GameSettings, RoomPublic } from '../types/index.js';
export declare const DEFAULT_SETTINGS: GameSettings;
export declare function createRoom(hostSocketId: string, hostName: string, settings?: Partial<GameSettings>): Room;
...
export declare function addPlayer(room: Room, socketId: string, name: string): Player;
