...
const VALID = new Set([...SOLUTIONS, ...EXTRA_VALID]);
...
export function puzzleNumber(now = Date.now()) {
...
export function shareGrid(rows, puzzle, solved) {
    const box = { hit: '🟩', near: '🟨', miss: '⬛' };
...
//# sourceMappingURL=wordBank.js.map