/**
 * Per-match voice membership for ჯაშუში (Spyfall) — mesh WebRTC fallback used
 * when LiveKit is not configured. Mirrors unoVoiceService.
 */
/**
...
//# sourceMappingURL=spyfallVoiceService.d.ts.map