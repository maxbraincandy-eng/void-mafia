...
import { forgetViewer, roomFor, } from './services/liveService.js';
...
export function attachSocketHandlers(io) {
    io.on('connection', (socket) => {
         ...
         */
        registerLiveHandlers(io, socket, { rateOk, ok, err });
        /*
         * ── Legacy character ──────────────────────────────────────────────────
         *
             ...
             */
            {
                ...
                if (gone) {
                    ...
                    for (const { sessionId, viewers } of forgetViewer(gone)) {
                        io.to(roomFor(sessionId)).emit('live:viewers', { sessionId, viewers, left: { userId: gone } });
                    }
                }
            }
